...
static PyObject *numpy$lib$arrayterator$$$function__4___array__$$$genexpr__1_genexpr_context(PyThreadState *tstate, struct Nuitka_GeneratorObject *generator, PyObject *yield_return_value) {
    ...
    }
    {
...

        {
            ...
            tmp_expression_value_1 = impl___main__$$$function__4_complex_call_helper_star_list(tstate, dir_call_args);
        }
        if (tmp_expression_value_1 == NULL) {
            assert(HAS_ERROR_OCCURRED(tstate));
...
static function_impl_code const function_table_numpy$lib$arrayterator[] = {
    impl_numpy$lib$arrayterator$$$function__1___init__,
    impl_numpy$lib$arrayterator$$$function__2___getattr__,
    impl_numpy$lib$arrayterator$$$function__3___getitem__,
    impl_numpy$lib$arrayterator$$$function__4___array__,
...
static PyObject *_reduce_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    int offset = Nuitka_Function_GetFunctionCodeIndex(function, function_table_numpy$lib$arrayterator);
...
static PyObject *_create_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    return (PyObject *)Nuitka_Function_CreateFunctionViaCodeIndex(
        ...
        kw_defaults,
        doc,
        function_table_numpy$lib$arrayterator,
        sizeof(function_table_numpy$lib$arrayterator) / sizeof(function_impl_code)
    );
}
