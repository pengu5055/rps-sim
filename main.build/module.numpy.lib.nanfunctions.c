...
static PyObject *impl_numpy$lib$nanfunctions$$$function__7_nanmin(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    branch_yes_4:;
    {
...

        {
            ...
            tmp_assign_source_2 = impl___main__$$$function__16_complex_call_helper_pos_keywords_star_dict(tstate, dir_call_args);
        }
        if (tmp_assign_source_2 == NULL) {
            assert(HAS_ERROR_OCCURRED(tstate));
...

    {
...

        {
            ...
            tmp_assign_source_8 = impl___main__$$$function__16_complex_call_helper_pos_keywords_star_dict(tstate, dir_call_args);
        }
    ...
    }
    {
...

        {
            ...
            tmp_assign_source_9 = impl___main__$$$function__16_complex_call_helper_pos_keywords_star_dict(tstate, dir_call_args);
        }
