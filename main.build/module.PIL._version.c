...
static void createModuleConstants(PyThreadState *tstate) {
    if (constants_created == false) {
        loadConstantsBlob(tstate, &mod_consts[0], UNTRANSLATE("PIL._version"));
...
static PyCodeObject *codeobj_8a59ab15051e32b80e3c937cabbf7209;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(mod_consts[8]); CHECK_OBJECT(module_filename_obj);
    codeobj_8a59ab15051e32b80e3c937cabbf7209 = MAKE_CODE_OBJECT(module_filename_obj, 1, 0, mod_consts[9], mod_consts[9], NULL, NULL, 0, 0, 0);
}
...
static PyObject *_reduce_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    int offset = Nuitka_Function_GetFunctionCodeIndex(function, function_table_PIL$_version);
...
PyObject *modulecode_PIL$_version(PyThreadState *tstate, PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *loader_entry) {
    // Report entry to PGO.
    ...
    UPDATE_STRING_DICT0(moduledict_PIL$_version, (Nuitka_StringObject *)const_str_plain___loader__, (PyObject *)&Nuitka_Loader_Type);
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_8a59ab15051e32b80e3c937cabbf7209;
    ...
    // Module code.
    {
        ...
        UPDATE_STRING_DICT0(moduledict_PIL$_version, (Nuitka_StringObject *)mod_consts[0], tmp_assign_source_1);
    }
    {
    ...
    frame_8a59ab15051e32b80e3c937cabbf7209 = MAKE_MODULE_FRAME(codeobj_8a59ab15051e32b80e3c937cabbf7209, module_PIL$_version);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_8a59ab15051e32b80e3c937cabbf7209);
    assert(Py_REFCNT(frame_8a59ab15051e32b80e3c937cabbf7209) == 2);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_8a59ab15051e32b80e3c937cabbf7209, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_8a59ab15051e32b80e3c937cabbf7209->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_8a59ab15051e32b80e3c937cabbf7209, exception_lineno);
    }



    assertFrameObject(frame_8a59ab15051e32b80e3c937cabbf7209);
